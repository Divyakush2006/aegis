...
code scanning all speak. Emitting it is what lets Prahari results be consumed by
...
TOOL_NAME = "Prahari"
TOOL_URI = "https://github.com/Divyakush2006/prahari"
...
def build_result(finding: Finding, rule_index: dict[str, int], base: Path | None) -> dict:
    result = {
        ...
        "partialFingerprints": {"prahariPathHash/v1": finding.path.fingerprint},
        "properties": {
