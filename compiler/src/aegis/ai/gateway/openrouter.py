...
Retries, pacing, quotas and budget live in :mod:`aegis.ai.gateway.http`.
"""
...
#: The free review model; see ``aegis.ai.config.PROVIDER_DEFAULTS``.
...
REFERER = "https://github.com/Divyakush2006/aegis"
TITLE = "Aegis Compiler"
...
def _from_content(message: dict, expect_tool: bool, require_tools: bool, finish: str = "") -> dict:
    ...
    if finish == "length":
        ...
        raise GatewayError(
            ...
            "raise AEGIS_AI_MAX_TOKENS or lower AEGIS_AI_REASONING"
        )
    raise GatewayError(
