...
/**
 * The tokenizer covers what a real C file contains, not only the subset Aegis
 ...
 */
@injectable()
export class AegisCLanguageContribution implements FrontendApplicationContribution {
    initialize(): void {
        registerCLanguage();
    }
}
